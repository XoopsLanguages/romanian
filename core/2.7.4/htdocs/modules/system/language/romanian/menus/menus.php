...
define('MENUS_HOME', 'Acasă');
define('MENUS_ADMIN', 'Administrare');
define('MENUS_ACCOUNT', 'Cont');
define('MENUS_ACCOUNT_EDIT', 'Editează contul');
define('MENUS_ACCOUNT_LOGIN', 'Autentificare');
define('MENUS_ACCOUNT_LOGOUT', 'Deconectare');
define('MENUS_ACCOUNT_REGISTER', 'Înregistrare');
define('MENUS_ACCOUNT_MESSAGES', 'Mesaje');
define('MENUS_ACCOUNT_NOTIFICATIONS', 'Notificări');
define('MENUS_ACCOUNT_TOOLBAR', 'Bară de instrumente');
