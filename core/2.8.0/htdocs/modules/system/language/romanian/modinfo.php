...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Activați administrarea limbilor');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Gestionați registrul de locale, pachetele de limbă, verificările de stare și suprascrierile de traducere ale site-ului.');
define('_MI_SYSTEM_BNAME14', 'Comutator de limbă');
